 ...
 */
std::vector<PriorityQueueDataPtr<int>> PriorityQueueTestData::getData() const
{
    std::vector<PriorityQueueDataPtr<int>> data;
 ...
 */
PriorityQueueDataPtr<int> PriorityQueueTestData::getPriorityQueueData1()
{
    std::vector<int> data;

    return PriorityQueueDataPtr<int>(new PriorityQueueData<int>(
 ...
 */
PriorityQueueDataPtr<int> PriorityQueueTestData::getPriorityQueueData2()
{
 ...
 */
PriorityQueueDataPtr<int> PriorityQueueTestData::getPriorityQueueData3()
{
 ...
 */
PriorityQueueDataPtr<int> PriorityQueueTestData::getPriorityQueueData4()
{
 ...
 */
PriorityQueueDataPtr<int> PriorityQueueTestData::getPriorityQueueData5()
{
