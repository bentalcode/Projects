...
/**
 * The ThreeDimensionalListIterator class implements an iterator of a three dimensional list.
 */
public final class ThreeDimensionalListIterator<T> implements IIterator<T> {
    ...
    /**
     * Creates a new iterator of a three dimensional list.
     */
    public static <T> IIterator<T> of(List<List<List<T>>> data) {
    ...
    private ThreeDimensionalListIterator(List<List<List<T>>> data) {
        Conditions.validateNotNull(
            data,
            "The three dimensional list to iterate.");
