...
public final class CollectionComparator<T> implements ICollectionComparator<T> {
    ...
    public boolean isEqual(Collection<T> lhs, Collection<T> rhs, IBinaryComparator<T> comparator) {
        ...
        return this.isEqual(Iterator.of(lhs), Iterator.of(rhs), comparator);
    }
    ...
    public int compareTo(Collection<T> lhs, Collection<T> rhs, IBinaryComparator<T> comparator) {
        ...
        return this.compareTo(Iterator.of(lhs), Iterator.of(rhs), comparator);
    }
     ...
     */
    @Override
    public boolean isEqual(IIterator<T> lhs, IIterator<T> rhs, IBinaryComparator<T> comparator) {
        Conditions.validateNotNull(
            comparator,
            "The comparator of a collection element.");
     ...
     */
    @Override
    public int compareTo(IIterator<T> lhs, IIterator<T> rhs, IBinaryComparator<T> comparator) {
        Conditions.validateNotNull(
            comparator,
            "The comparator of a collection element.");
