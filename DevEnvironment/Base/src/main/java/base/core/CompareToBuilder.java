...
public final class CompareToBuilder implements ICompareToBuilder {
     ...
     */
    @Override
    public ICompareToBuilder withAlmostDouble(double lhs, double rhs, double epsilon)
    {
        if (this.compareStatus != 0) {
            return this;
        }

        IComparableComparator<Double> comparator = this.comparatorFactory.createAlmostDoubleComparator(epsilon);
        this.compareStatus = comparator.compareTo(lhs, rhs);
     ...
     */
    @Override
    public ICompareToBuilder withDuration(Duration lhs, Duration rhs) {
        IComparableComparator<Duration> comparator = this.comparatorFactory.createDurationComparator();
        return this.withObject(lhs, rhs, comparator);
    }
