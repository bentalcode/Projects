...
public final class StringsTest {
     ...
     */
    @Test
    public void findAllSubStringKmpTest() {
        String str1 = "AAACAAAAC";
        String subString1 = null;
        ...
        this.testAllSubStringKmp(str1, subString1, expectedResult1);
        this.testAllSubStringKmp(str2, subString2, expectedResult2);
        this.testAllSubStringKmp(str3, subString3, expectedResult3);
        this.testAllSubStringKmp(str4, subString4, expectedResult4);
        this.testAllSubStringKmp(str5, subString5, expectedResult5);
        this.testAllSubStringKmp(str6, subString6, expectedResult6);
        this.testAllSubStringKmp(str7, subString7, expectedResult7);
        this.testAllSubStringKmp(str8, subString8, expectedResult8);
        this.testAllSubStringKmp(str9, subString9, expectedResult9);
    }
     ...
     */
    @Test
    public void findAllSubCharacterArrayKmpTest() {
        String str1 = "CBAAACAAAACFH";
        int strStartIndex1 = 2;
        int strEndIndex1 = 10;
        String subString1 = null;
     ...
     * Tests the logic of finding all sub string with KMP Algorithm.
     */
    private void testAllSubStringKmp(
        String str,
        String subString,
        List<Integer> expectedResult) {

        List<Integer> result = StringSearch.findAllSubStringKmp(str, subString);
    ...
    private void testAllSubStringKmp(
        ...
        List<Integer> result = StringSearch.findAllSubStringKmp(
            str, strStartIndex, strEndIndex,
            subString, subStringStartIndex, subStringEndIndex);
