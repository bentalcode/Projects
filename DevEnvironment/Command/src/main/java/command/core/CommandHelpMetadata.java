...
public final class CommandHelpMetadata implements ICommandHelpMetadata {
    ...
    private static final String DEFAULT_SHORT_NAME = CommandConstants.HELP_SHORT_NAME;
    private static final String DEFAULT_LONG_NAME = CommandConstants.HELP_LONG_NAME;
