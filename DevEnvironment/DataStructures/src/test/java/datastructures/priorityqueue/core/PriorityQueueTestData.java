...
public final class PriorityQueueTestData implements IPriorityQueueTestData {
    ...
    private IPriorityQueueData<Integer> getPriorityQueueData2() {
        List<Integer> creationData = ArrayLists.make(14, 10, 5, 9, 6, 3, 2, 1);
        List<Integer> expectedData = ArrayLists.make(1, 2, 3, 6, 9, 10, 5, 14);
    ...
    private IPriorityQueueData<Integer> getPriorityQueueData3() {
        List<Integer> creationData = ArrayLists.make(14, 6, 5, 9, 1, 3, 2, 10);
        List<Integer> expectedData = ArrayLists.make(1, 5, 2, 10, 9, 6, 3, 14);
    ...
    private IPriorityQueueData<Integer> getPriorityQueueData4() {
        List<Integer> creationData = ArrayLists.make(2, 20, 5, 20, 19, 15, 50, 30);
        List<Integer> expectedData = ArrayLists.make(50, 30, 20, 20, 19, 5, 15, 2);
    ...
    private IPriorityQueueData<Integer> getPriorityQueueData5() {
        List<Integer> creationData = ArrayLists.make(-7, 6, 0, 9, 1, 3, 4, -3, 5, -1);
        List<Integer> expectedData = ArrayLists.make(9, 6, 4, 5, 1, 0, 3, -7, -3, -1);
